        ...
        <section className="about">
            <div className="container">
                <div className="chef-info">
                    <h1>Tasty Food</h1>
                    <h2>Chicago</h2>
                    <p>Tasty Food Restaurant is owned by two Italian brothers, Mario and Adrian, who moved to the United States to pursue their shared dream of owning a restaurant.<br/><br/>
